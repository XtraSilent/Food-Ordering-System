...
<html>
<head>
<title>FSKM FOod Ordering System</title>
<!-- Custom Theme files -->
...
<body>
		...
		<div class="header">
			<div class="container">
				<div class="header-left">	
					<h1><a href="#">Food Ordering</a></h1>
				</div> 
				<div class="header-right">	
					<ul>
						<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>+60 17 531 3151</li>
						<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:example@mail.com">alifruzycs@gmail.com</a></li>
					</ul>
				</div>
		...
		<div class="banner-text agileits">
			...
			<div  id="top" class="callbacks_container">
				<ul class="rslides" id="slider3">
					<li>					
                    <a href="../user/food" target="_new" ><h2>Foods Are The Best</h2><p><h3>Click this to see our menu</h3></a></li>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
                        ...
                        <li class="hvr-bounce-to-bottom"><a href="../user/food" target="_new" >See Our Menus</a></li>
					</ul>	
					<div class="clearfix"> </div>
				</div>	
			</div>
	...
	<div id="about" class="about">
		<div class="container">
			...
			<h6>It is a long established fact that a student will be distracted by the readable content of a page when looking at its layout.</h6>
	...
	<!--map-->
	<div class="map">
    <div style="height: 400px; width: 100%;">{!! Mapper::render() !!}</div>          
	</div>
	<!--//map-->
	<!--contact-->
		...
		<div class="container">
			<h3 class="title">Contact Us</h3>
				...
				<div class="col-md-5 col-sm-5 contact-right">
					<h4>Contact Info</h4>
					<p>Contact Us if You want to Booking</p>
					<p>May Force Be With You!</p>
					<div class="con-right-grid1">
						<div class="col-md-1 col-sm-1 contact-icon">
							<i class="fa fa-map-marker" aria-hidden="true"></i>
						</div>
						<div class="col-md-11 col-sm-11 contact-text">
							<h5>Jalan Merlimau 9</h5>
							<h5>JB 3368,Taman Merlimau Melaka</h5>
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="con-right-grid3">
						...
						<div class="col-md-11 col-sm-11 contact-text">
							<h5><a href="mailto:example@mail.com">alifruzycs@gmail.com</a></h5>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
